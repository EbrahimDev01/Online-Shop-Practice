        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Descritption = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Images_UserImageId",
                        column: x => x.UserImageId,
                        principalTable: "Images",
                        principalColumn: "ImageId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UserWallets_UserWalletId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CartIsActive = table.Column<bool>(type: "bit", nullable: false),
                    DateTimeCompleteCart = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserWalletDetailsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ReasonTransaction = table.Column<int>(type: "int", nullable: false),
                    UserWalletId = table.Column<int>(type: "int", nullable: false),
                    CartId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWalletDetails", x => x.UserWalletDetailsId);
                    table.ForeignKey(
                        name: "FK_UserWalletDetails_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWalletDetails_UserWallets_UserWalletId",
                        column: x => x.UserWalletId,
                        principalTable: "UserWallets",
                        principalColumn: "UserWalletId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserWalletId",
                table: "AspNetUsers",
                column: "UserWalletId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWalletDetails_CartId",
                table: "UserWalletDetails",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_UserWalletDetails_UserWalletId",
                table: "UserWalletDetails",
                column: "UserWalletId");
        }
